  ...
  return [
    {
      ...
      price: 74.99,
      description:
        "The Women's Adidas VL Court 3.0 Sneaker combines the versatility of an iconic casual look with a modern fresh attitude. With the classic T-Toe design reinterpreted for a fresh appeal, you'll be sure to spark curiosity in this street look.\n\n" +
    ...
    },
    {
      ...
      price: 69.98,
      description:
        "Retro gets modernized with the Women's Nike Waffle Debut Retro Sneaker.\n\n" +
    ...
    },
    {
      ...
      price: 89.99,
      description:
        "Elevate your style with the Women's Nike Court Legacy Lift Platform Sneaker.\n\n" +
    ...
    },
    {
      ...
      price: 79.98,
      description:
        "Combine the bounce and beauty of Max Air cushioning during demanding workouts with the Women's Nike Air Max Bella 5 Training Shoe.\n\n" +
    ...
    },
    {
      ...
      price: 94.99,
      description:
        "Finish your last rep with power and rack it with a roar that stuns the gym floor in the Men's Nike Air Max Alpha Trainer 5 Sneaker.\n\n" +
    ...
    },
    {
      ...
      price: 94.99,
      description:
        "A new twist on an iconic look: the Men's Nike Air Max Excee Sneaker.\n\n" +
    ...
    },
    {
      ...
      price: 99.99,
      description:
        "Updated traction pattern. Durable materials. Metal hardware. Check, check and check. The Men's Nike Vision Mid Winter Sneaker lets you bring your retro hoops vibes into wintertime.\n\n" +
    ...
    },
    {
      ...
      price: 79.99,
      description:
        "Sleek, stylish, and comfortable, you can't go wrong with the Men's Puma Hypnotic LS Sneaker.\n\n" +
    ...
    },
    {
      ...
      price: 69.99,
      description:
        "Stylish and comfortable, the Men's Puma Club 5v5 Low Top Sneaker.\n\n" +
        '- Synthetic leather upper in a sneaker style with a round toe\n' +
        '- Lace-up front\n' +
