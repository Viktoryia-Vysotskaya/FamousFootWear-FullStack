...
const create_order_item_dto_1 = require("./dtos/create-order-item.dto");
const jwt_auth_guard_1 = require("../auth/quards/jwt-auth.guard");
const admin_auth_guard_1 = require("../auth/quards/admin-auth.guard");
let OrdersController = class OrdersController {
    ...
    createOrderItem(orderId, createOrderItemDto) {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, create_order_item_dto_1.CreateOrderItemDTO]),
    __metadata("design:returntype", void 0)
], OrdersController.prototype, "createOrderItem", null);
__decorate([
    (0, common_1.Post)('/proceed-order'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
